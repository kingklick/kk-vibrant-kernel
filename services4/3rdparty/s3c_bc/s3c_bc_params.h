...
#define S3C_BC_DEVICE_BUFFER_COUNT			4								
#define S3C_BC_DEVICE_PHYS_ADDR_START		((unsigned int)s3c_get_media_memory(S3C_MDEV_TEXSTREAM)) 
#define S3C_BC_DEVICE_WIDTH					800								
#define S3C_BC_DEVICE_HEIGHT				800								
#define S3C_BC_DEVICE_PIXELFORMAT			(PVRSRV_PIXEL_FORMAT_ARGB8888)
#define S3C_BC_DEVICE_STRIDE				(S3C_BC_DEVICE_WIDTH*4)
#define S3C_BC_DEVICE_PHYS_PAGE_SIZE		0x1000							
